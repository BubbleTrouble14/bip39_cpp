...
using LangTests = std::map<std::string, std::vector<TestCase>>;

inline void InitLangTests(LangTests& tests)
{
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("english", {
        {
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("chinese_simplified", {
        {
            "00000000000000000000000000000000",
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("chinese_traditional", {
        {
            "00000000000000000000000000000000",
            "的 的 的 的 的 的 的 的 的 的 的 在",
            "7f7c7f91ef81f0fb6a3b95b346c50e6472c1d554f8ba90637bad8afce4a4de87c322c1acafa2f6f5e9a8f9b2d2c40e9d389efdc2adbe4445c21a0939fb39e91f",
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("czech", {
        {
            "00000000000000000000000000000000",
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("french", {
        {
            "00000000000000000000000000000000",
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("italian", {
        {
            "00000000000000000000000000000000",
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("japanese", {
        {
            "00000000000000000000000000000000",
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("korean", {
        {
            "00000000000000000000000000000000",
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("portuguese", {
        {
            "00000000000000000000000000000000",
    ...
    tests.insert(std::make_pair<std::string, std::vector<TestCase>>("spanish", {
        {
            "00000000000000000000000000000000",
